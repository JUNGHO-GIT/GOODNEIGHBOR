  ...
  <body>
    ...
    <main class="main container-fluid">
      ...
      <div class="row d-flex justify-content-center align-items-start my-5">
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-8 col-xs-8 col-8">
          <div class="card shadow donation-card">
            <img src="${srcPath}/upload/${dto.product_image}" class="product-img img-fluid rounded-top" alt="Product Image"/>
          </div>
        </div>
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-8 col-xs-8 col-8">
          <div class="card shadow donation-card">
            <div class="card-body">
              ...
              <div class="d-flex justify-content-start align-items-center">
                <h4 class="card-text">후원 금액&nbsp;:&nbsp;</h4>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <h5 class="card-text mb-1" id="donation_amount">&#8361;<fmt:formatNumber value='${dto.product_price}' type='number' pattern='#,###'/></h5>
                <span>&nbsp;&nbsp;/&nbsp;&nbsp;&#8361;</span>
                <h5 class="card-text mb-1" id="randomAmount"></h5>
              </div>
              <br/>
              <div class="d-flex justify-content-start align-items-center">
                ...
                <h5 class="card-text mb-1">${member_id}</h5>
              </div>
              <br/>
              <div class="d-flex justify-content-start align-items-center">
                <h4 class="card-text">후원 시간&nbsp;:&nbsp;</h4>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <span class="me-2"><i class="fas fa-clock"></i></span>
                <h5 class="card-text mb-1" id="time"></h5>
              </div>
              <br/><br/>
